...
namespace Services
{
    ...
    [System.ServiceModel.ServiceContractAttribute(Namespace="urn:ec.europa.eu:taxud:vies:services:checkVat", ConfigurationName="Services.checkVatPortType")]
    public interface checkVatPortType
    {
        ...
        System.Threading.Tasks.Task<Services.checkVatResponse> checkVatAsync(Services.checkVatRequest request);
        
        // CODEGEN: Generating message contract since the operation has multiple return values.
        [System.ServiceModel.OperationContractAttribute(Action="", ReplyAction="*")]
        [System.ServiceModel.XmlSerializerFormatAttribute(SupportFaults=true)]
        System.Threading.Tasks.Task<Services.checkVatApproxResponse> checkVatApproxAsync(Services.checkVatApproxRequest request);
    }
    ...
    public partial class checkVatApproxResponse
    {
        ...
        public checkVatApproxResponse(
                    ...
                    string traderCity, 
                    Services.matchCode traderNameMatch, 
                    Services.matchCode traderCompanyTypeMatch, 
                    Services.matchCode traderStreetMatch, 
                    Services.matchCode traderPostcodeMatch, 
                    Services.matchCode traderCityMatch, 
    ...
    [System.CodeDom.Compiler.GeneratedCodeAttribute("Microsoft.Tools.ServiceModel.Svcutil", "8.0.0")]
    public interface checkVatPortTypeChannel : Services.checkVatPortType, System.ServiceModel.IClientChannel
    {
    }
    
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.CodeDom.Compiler.GeneratedCodeAttribute("Microsoft.Tools.ServiceModel.Svcutil", "8.0.0")]
    public partial class checkVatPortTypeClient : System.ServiceModel.ClientBase<Services.checkVatPortType>, Services.checkVatPortType
    {
        ...
        public System.Threading.Tasks.Task<Services.checkVatResponse> checkVatAsync(Services.checkVatRequest request)
        {
            return base.Channel.checkVatAsync(request);
        }
        
        public System.Threading.Tasks.Task<Services.checkVatApproxResponse> checkVatApproxAsync(Services.checkVatApproxRequest request)
        {
